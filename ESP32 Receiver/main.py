...
#lora è disponibile? si? vado avanti
...
packet, SNR, RSSI = lora.read_fifo()
#display.show_text_wrap("I have received  {0} ".format(received_payload))
display.show_text_wrap("I have received {0} RSSI: {1}  SNR : {2}".format(received_payload, RSSI, SNR))
##########################################################################################
...
#qui puoi inviare un sending di ritorno al sender
#display.show_text_wrap("I have received {0} RSSI: {1}  SNR : {2}".format(received_payload, RSSI, SNR))
